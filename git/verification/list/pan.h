...
#define _nstates2	11	/* list_pop */
#define minseq2	47
#define maxseq2	56
#define _endstate2	10

#define _nstates1	24	/* list_remove */
#define minseq1	24
#define maxseq1	46
#define _endstate1	23

#define _nstates0	25	/* list_add */
#define minseq0	0
#define maxseq0	23
...
#define Plist_pop	((P2 *)_this)
typedef struct P2 { /* list_pop */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, first_item) - 1*sizeof(int))

#define Plist_remove	((P1 *)_this)
typedef struct P1 { /* list_remove */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, curr) - 1*sizeof(int))

#define Plist_add	((P0 *)_this)
typedef struct P0 { /* list_add */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
