...
#define _nstates7	11	/* no_continuous_overflow */
#define minseq7	146
#define maxseq7	155
#define _endstate7	10

#define _nstates6	11	/* buffer_size_invariant */
#define minseq6	136
#define maxseq6	145
#define _endstate6	10

#define _nstates5	11	/* packet_flow_safety */
#define minseq5	126
#define maxseq5	135
#define _endstate5	10

#define _nstates4	21	/* :init: */
#define minseq4	106
#define maxseq4	125
#define _endstate4	20

#define _nstates3	25	/* packetbuf_hdralloc */
#define minseq3	82
#define maxseq3	105
#define _endstate3	24

#define _nstates2	48	/* packetbuf_copyfrom */
#define minseq2	35
#define maxseq2	81
#define _endstate2	47
...
#define _nstates0	30	/* packetbuf_attr_clear */
#define minseq0	0
#define maxseq0	28
...
typedef struct P7 { /* no_continuous_overflow */
...
typedef struct P6 { /* buffer_size_invariant */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* packet_flow_safety */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air4	(sizeof(P4) - Offsetof(P4, _7_5_choice) - 1*sizeof(int))

#define Ppacketbuf_hdralloc	((P3 *)_this)
typedef struct P3 { /* packetbuf_hdralloc */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, _6_4_i) - 1*sizeof(int))
...
#define Air2	(sizeof(P2) - Offsetof(P2, _5_3_j) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar error_overflow;
/* hidden variable: */	int bufptr;
