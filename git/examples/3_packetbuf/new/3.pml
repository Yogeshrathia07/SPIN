...
#define MAX_PACKETS 10  // Global state variables for LTL verification
...
// ltl attr_clear_after_clear { [](buflen == 0 && bufptr == 0 && hdrlen == 0 -> [] (forall i :: packetbuf_attrs[i].val == 0 && packetbuf_addrs[i].addr == 0 && packetbuf_addrs[i].is_null)) }
