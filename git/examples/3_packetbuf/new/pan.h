...
#define _nstates9	14	/* valid_copyto */
#define minseq9	135
#define maxseq9	147
#define _endstate9	13

#define _nstates8	11	/* header_allocation_reduction */
#define minseq8	125
#define maxseq8	134
#define _endstate8	10

#define _nstates7	11	/* buffer_safety */
#define minseq7	115
#define maxseq7	124
#define _endstate7	10

#define _nstates6	11	/* :init: */
#define minseq6	105
#define maxseq6	114
#define _endstate6	10

#define _nstates5	12	/* packetbuf_hdrreduce */
#define minseq5	94
#define maxseq5	104
#define _endstate5	11

#define _nstates4	22	/* packetbuf_hdralloc */
#define minseq4	73
#define maxseq4	93
#define _endstate4	21

#define _nstates3	28	/* packetbuf_copyto */
#define minseq3	46
#define maxseq3	72
#define _endstate3	27

#define _nstates2	20	/* packetbuf_copyfrom */
#define minseq2	27
#define maxseq2	45
#define _endstate2	19

#define _nstates1	7	/* packetbuf_clear */
#define minseq1	21
#define maxseq1	26
#define _endstate1	6

#define _nstates0	22	/* packetbuf_attr_clear */
#define minseq0	0
#define maxseq0	20
...
struct Attribute { /* user defined type */
	int val;
};
struct Address { /* user defined type */
	int addr;
	unsigned is_null : 1;
};
typedef struct P9 { /* valid_copyto */
...
typedef struct P8 { /* header_allocation_reduction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* buffer_safety */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Ppacketbuf_hdrreduce	((P5 *)_this)
typedef struct P5 { /* packetbuf_hdrreduce */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air5	(sizeof(P5) - Offsetof(P5, result) - 1*sizeof(int))

#define Ppacketbuf_hdralloc	((P4 *)_this)
typedef struct P4 { /* packetbuf_hdralloc */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air4	(sizeof(P4) - Offsetof(P4, _7_5_i) - 1*sizeof(int))

#define Ppacketbuf_copyto	((P3 *)_this)
typedef struct P3 { /* packetbuf_copyto */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, _6_4_j) - 1*sizeof(int))

#define Ppacketbuf_copyfrom	((P2 *)_this)
typedef struct P2 { /* packetbuf_copyfrom */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, _5_3_i) - 1*sizeof(int))

#define Ppacketbuf_clear	((P1 *)_this)
typedef struct P1 { /* packetbuf_clear */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Ppacketbuf_attr_clear	((P0 *)_this)
typedef struct P0 { /* packetbuf_attr_clear */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _3_1_i) - 1*sizeof(int))
...
typedef struct State {
	...
	#endif
#endif
	unsigned header_allocated : 1;
	uchar packetbuf[128];
	int total_header_reductions;
	int buflen;
	int bufptr;
	int hdrlen;
	struct Attribute packetbuf_attrs[16];
	struct Address packetbuf_addrs[8];
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar buffer_copied;
/* hidden variable: */	int total_header_allocations;
